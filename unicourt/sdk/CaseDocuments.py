...
class CaseDocuments:
    ...
    def get_case_document_order_callbacks(
        var_date: Annotated[Optional[datetime], Field(description="Date for which fetch the Case Document Order Callback list. By default, the date will be set to current date.")] = None,
        ...
        :param var_date: Date for which fetch the Case Document Order Callback list. By default, the date will be set to current date.
        ...
        """
        with utils.api_client() as api_client:
            response = CaseDocumentsApi(api_client).get_case_document_order_callbacks_with_http_info(var_date = var_date, status = status, page_number = page_number, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
            return (response.data, response.status_code)
    ...
    def get_case_document_order_callbacks_with_http_info(
        ...
        """
        with utils.api_client() as api_client:
            return CaseDocumentsApi(api_client).get_case_document_order_callbacks_with_http_info(var_date = var_date, status = status, page_number = page_number, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
    ...
    def get_case_document_order_callbacks_without_preload_content(
        ...
        """
        with utils.api_client() as api_client:
            response = CaseDocumentsApi(api_client).get_case_document_order_callbacks_without_preload_content_with_http_info(var_date = var_date, status = status, page_number = page_number, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
            return (response.data, response.status_code)
