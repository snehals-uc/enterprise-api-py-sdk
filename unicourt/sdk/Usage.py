...
class Usage:
    ...
    def get_daily_usage_by_date(
        var_date: Annotated[date, Field(description="The specific date for which you wish to obtain information on API usage.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param var_date: The specific date for which you wish to obtain information on API usage. (required)
        :type var_date: date
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        """
        with utils.api_client() as api_client:
            response = UsageApi(api_client).get_daily_usage_by_date_with_http_info(var_date = var_date, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
            return (response.data, response.status_code)
    ...
    def get_daily_usage_by_date_with_http_info(
        ...
        """
        with utils.api_client() as api_client:
            return UsageApi(api_client).get_daily_usage_by_date_with_http_info(var_date = var_date, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
    ...
    def get_daily_usage_by_date_without_preload_content(
        ...
        """
        with utils.api_client() as api_client:
            response = UsageApi(api_client).get_daily_usage_by_date_without_preload_content_with_http_info(var_date = var_date, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
            return (response.data, response.status_code)
