...
class CaseExport:
    ...
    @staticmethod
    def export_case(
        case_id: Annotated[str, Field(min_length=18, strict=True, max_length=18, description="The caseId value of the case for which case export information is to be retrieved.")],
        ...
        :param case_id: The caseId value of the case for which case export information is to be retrieved. (required)
        :type case_id: str
    ...
    def get_case_export_callbacks(
        var_date: Annotated[Optional[datetime], Field(description="The date for which callbacks are to be retrieved.")] = None,
        ...
        :param var_date: The date for which callbacks are to be retrieved.
        ...
        """
        with utils.api_client() as api_client:
            response = CaseExportApi(api_client).get_case_export_callbacks_with_http_info(var_date = var_date, status = status, page_number = page_number, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
            return (response.data, response.status_code)
    ...
    def get_case_export_callbacks_with_http_info(
        ...
        """
        with utils.api_client() as api_client:
            return CaseExportApi(api_client).get_case_export_callbacks_with_http_info(var_date = var_date, status = status, page_number = page_number, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
    ...
    def get_case_export_callbacks_without_preload_content(
        ...
        """
        with utils.api_client() as api_client:
            response = CaseExportApi(api_client).get_case_export_callbacks_without_preload_content_with_http_info(var_date = var_date, status = status, page_number = page_number, _request_timeout = _request_timeout, _request_auth = _request_auth, _content_type = _content_type, _headers = _headers, _host_index = _host_index)
            return (response.data, response.status_code)
