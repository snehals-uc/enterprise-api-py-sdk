...
class PartyAttorneyAssociations(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=25, strict=True, max_length=25)]] = Field(default='PartyAttorneyAssociations', description="Name of the object")
    ...
    party_attorney_association_array: Optional[Annotated[List[PartyAttorneyAssociation], Field(max_length=25)]] = Field(default=None, alias="partyAttorneyAssociationArray")
