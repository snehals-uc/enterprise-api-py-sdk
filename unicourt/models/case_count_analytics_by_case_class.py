...
class CaseCountAnalyticsByCaseClass(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "caseCount", "caseSearchAPI", "caseClass"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'CaseCountAnalyticsByCaseClass',
