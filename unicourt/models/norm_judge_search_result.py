...
class NormJudgeSearchResult(BaseModel):
    ...
    norm_judge_id: Annotated[str, Field(min_length=17, strict=True, max_length=18)] = Field(alias="normJudgeId")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    first_fetch_date: datetime = Field(alias="firstFetchDate")
    last_fetch_date: datetime = Field(alias="lastFetchDate")
    norm_judge_details_api: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="normJudgeDetailsAPI")
