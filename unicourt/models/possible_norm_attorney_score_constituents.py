...
class PossibleNormAttorneyScoreConstituents(BaseModel):
    ...
    other_potential_norm_attorneys: StrictInt = Field(alias="otherPotentialNormAttorneys")
    bar_id: Annotated[str, Field(strict=True, max_length=250)] = Field(alias="barId")
    ...
    law_firm: Annotated[str, Field(strict=True, max_length=250)] = Field(alias="lawFirm")
