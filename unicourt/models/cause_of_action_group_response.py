...
class CauseOfActionGroupResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=26, strict=True, max_length=26)]] = 'CauseOfActionGroupResponse'
    cause_of_action_group_array: Optional[List[CauseOfActionGroup]] = Field(default=None, alias="causeOfActionGroupArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2151)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2150)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
