...
class CaseTypeResponse(BaseModel):
    ...
    CaseTypeResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=16, strict=True, max_length=16)]] = 'CaseTypeResponse'
    case_type_array: Optional[List[CaseType]] = Field(default=None, alias="caseTypeArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2139)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
