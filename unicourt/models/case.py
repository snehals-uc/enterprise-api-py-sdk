...
class Case(BaseModel):
    ...
    def source_data_status_validate_enum(cls, value):
        ...
        if value not in set(['NO_LONGER_AVAILABLE_IN_COURT', 'SOURCE_DEPRECATED', 'null']):
            raise ValueError("must be one of enum values ('NO_LONGER_AVAILABLE_IN_COURT', 'SOURCE_DEPRECATED', 'null')")
        return value
