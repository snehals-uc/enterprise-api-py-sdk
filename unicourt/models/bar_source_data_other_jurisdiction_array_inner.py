...
class BarSourceDataOtherJurisdictionArrayInner(BaseModel):
    """
    ...
    state: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    __properties: ClassVar[List[str]] = ["barNumber", "state"]
