...
class CaseCountAnalyticsByJurisdictionGeo(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=35)]] = 'CaseCountAnalyticsByJurisdictionGeo'
    ...
    jurisdiction_geo: Optional[JurisdictionGeo] = Field(default=None, alias="jurisdictionGeo")
