...
class BillingCycleUsageResponseBillingCycle(BaseModel):
    """
    StartDate and endDate of the billing cycle.
    """ # noqa: E501
    start_date: datetime = Field(description="Start date of the billing cycle.", alias="startDate")
    end_date: datetime = Field(description="End date of the billing cycle.", alias="endDate")
