...
class CourtSystemResponse(BaseModel):
    ...
    CourtSystemResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=19, strict=True, max_length=19)]] = 'CourtSystemResponse'
    court_system_array: Optional[List[CourtSystem]] = Field(default=None, alias="courtSystemArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2142)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2141)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
