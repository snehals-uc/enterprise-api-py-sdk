...
class RawOrderedDataChildChildArrayInner(BaseModel):
    """
    Contact object Data Schema.
    """ # noqa: E501
    lbl: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(description="Label of the docket from the source.")
    ...
    child_array: List[Dict[str, Any]] = Field(alias="childArray")
    __properties: ClassVar[List[str]] = ["lbl", "ord", "val", "childArray"]
