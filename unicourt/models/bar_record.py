...
class BarRecord(BaseModel):
    ...
    bar_number: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="barNumber")
    bar_source_type: Annotated[str, Field(strict=True, max_length=70)] = Field(alias="barSourceType")
    admitted_date: Optional[datetime] = Field(description="The admittedDate is the date when an attorney was admitted to the bar of a given state.", alias="admittedDate")
    state_code: Annotated[str, Field(strict=True, max_length=2)] = Field(alias="stateCode")
    status: Annotated[str, Field(strict=True, max_length=15)]
    ...
    last_fetch_date_with_updates: datetime = Field(description="Last Fetch Date of the Attorney Update.", alias="lastFetchDateWithUpdates")
