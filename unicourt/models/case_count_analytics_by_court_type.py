...
class CaseCountAnalyticsByCourtType(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=29)]] = 'CaseCountAnalyticsByCourtType'
    ...
    court_type: Optional[CourtType] = Field(default=None, alias="courtType")
