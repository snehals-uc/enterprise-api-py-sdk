...
class CaseCountAnalyticsByCourtGeo(BaseModel):
    """
    CaseCountAnalyticsByCourtGeo
    """ # noqa: E501
    latitude: Optional[Annotated[str, Field(strict=True, max_length=15)]]
    longitude: Optional[Annotated[str, Field(strict=True, max_length=15)]]
