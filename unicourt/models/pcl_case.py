...
class PCLCase(BaseModel):
    ...
    PCLCase
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=7, strict=True, max_length=7)]] = Field(default='PCLCase', description="Name of the object")
    ...
    pacer_search_results_array: Optional[List[PACERCaseSearchResults]] = Field(default=None, alias="pacerSearchResultsArray")
