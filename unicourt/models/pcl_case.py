...
class PCLCase(BaseModel):
    ...
    PCLCase
    """ # noqa: E501
    object: Annotated[str, Field(min_length=7, strict=True, max_length=7)] = Field(description="Name of the object")
    ...
    pacer_search_results_array: List[PACERCaseSearchResults] = Field(alias="pacerSearchResultsArray")
    next_page_api: Optional[Annotated[str, Field(strict=True, max_length=1000000)]] = Field(description="Link to next page of the PCL Search Results.", alias="nextPageAPI")
    total_pages: StrictInt = Field(description="Total number of pages to obtain all the objects the current PCL Search.", alias="totalPages")
    total_count: StrictInt = Field(description="Total number of records available for this Search.", alias="totalCount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'PCLCase',
            ...
            "pacerSearchResultsArray": [PACERCaseSearchResults.from_dict(_item) for _item in obj["pacerSearchResultsArray"]] if obj.get("pacerSearchResultsArray") is not None else None,
