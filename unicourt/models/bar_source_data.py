...
class BarSourceData(BaseModel):
    ...
    administrative_actions_array: List[BarSourceDataAdministrativeActionsArrayInner] = Field(alias="administrativeActionsArray")
    admission_type: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="admissionType")
    appellate_court_district: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="appellateCourtDistrict")
    appellate_division_department: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="appellateDivisionDepartment")
    attorney_group: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="attorneyGroup")
    authorized: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    bar_service_class: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="barServiceClass")
    bio: Optional[Annotated[str, Field(strict=True, max_length=5000)]]
    board_certifications_array: List[BarSourceDataBoardCertificationsArrayInner] = Field(alias="boardCertificationsArray")
    board_district: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="boardDistrict")
    circuit: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    comments: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    committees_array: List[BarSourceDataCommitteesArrayInner] = Field(alias="committeesArray")
    court_history_array: List[BarSourceDataCourtHistoryArrayInner] = Field(alias="courtHistoryArray")
    court_of_admissions: BarSourceDataCourtOfAdmissions = Field(alias="courtOfAdmissions")
    court_service_email: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="courtServiceEmail")
    disciplinary_history_array: List[BarSourceDataDisciplinaryHistoryArrayInner] = Field(alias="disciplinaryHistoryArray")
    discipline_summaries_array: List[BarSourceDataDisciplineSummariesArrayInner] = Field(alias="disciplineSummariesArray")
    dismissals_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="dismissalsArray")
    district: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    employment_history_array: List[BarSourceDataEmploymentHistoryArrayInner] = Field(alias="employmentHistoryArray")
    expiration_date: Optional[datetime] = Field(alias="expirationDate")
    fees_options_array: List[BarSourceDataFeesOptionsArrayInner] = Field(alias="feesOptionsArray")
    firm_size: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="firmSize")
    firm_website: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(alias="firmWebsite")
    first_admitted_date: Optional[datetime] = Field(description="The firstAdmittedDate is the date when an attorney was admitted to the bar for the very first time regardless of which U.S state.", alias="firstAdmittedDate")
    first_admitted_year: Optional[StrictInt] = Field(alias="firstAdmittedYear")
    home_county: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="homeCounty")
    in_good_standing: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="inGoodStanding")
    insurance: Optional[Annotated[str, Field(strict=True, max_length=500)]]
    involvements_array: List[BarSourceDataInvolvementsArrayInner] = Field(alias="involvementsArray")
    judicial_district: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="judicialDistrict")
    juris_type: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="jurisType")
    languages_array: List[Annotated[str, Field(strict=True, max_length=1000)]] = Field(alias="languagesArray")
    last_renewal_date: Optional[datetime] = Field(alias="lastRenewalDate")
    law_school_array: List[BarSourceDataLawSchoolArrayInner] = Field(alias="lawSchoolArray")
    legal_speciality_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="legalSpecialityArray")
    license_type: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="licenseType")
    name: BarSourceDataName
    next_registration: Optional[datetime] = Field(alias="nextRegistration")
    next_renewal_date: Optional[datetime] = Field(alias="nextRenewalDate")
    open_action_status_array: List[BarSourceDataOpenActionStatusArrayInner] = Field(alias="openActionStatusArray")
    other_jurisdiction_array: List[BarSourceDataOtherJurisdictionArrayInner] = Field(alias="otherJurisdictionArray")
    other_name_array: List[Annotated[str, Field(strict=True, max_length=500)]] = Field(alias="otherNameArray")
    parish: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    pending_proceeding_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="pendingProceedingArray")
    position: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    practice_area_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="practiceAreaArray")
    practice_location_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="practiceLocationArray")
    private_law_practice: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="privateLawPractice")
    profile_last_certified: Optional[datetime] = Field(alias="profileLastCertified")
    public_hearing_array: List[BarSourceDataPublicHearingArrayInner] = Field(alias="publicHearingArray")
    reason_for_inactivation: BarSourceDataReasonForInactivation = Field(alias="reasonForInactivation")
    sections_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="sectionsArray")
    services_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="servicesArray")
    source_info: BarSourceDataSourceInfo = Field(alias="sourceInfo")
    statewide_grievance_committee_history_array: List[BarSourceDataStatewideGrievanceCommitteeHistoryArrayInner] = Field(alias="statewideGrievanceCommitteeHistoryArray")
    status: Optional[Annotated[str, Field(strict=True, max_length=500)]]
    status_date: Optional[datetime] = Field(alias="statusDate")
    status_history_array: List[BarSourceDataStatusHistoryArrayInner] = Field(alias="statusHistoryArray")
    ten_year_discipline_array: List[BarSourceDataTenYearDisciplineArrayInner] = Field(alias="tenYearDisciplineArray")
    undergraduate_school: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="undergraduateSchool")
    bar_law_firm: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="barLawFirm")
    years_of_practice: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="yearsOfPractice")
    clients_represented_array: List[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="clientsRepresentedArray")
    status_hint: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(alias="statusHint")
    advanced_degree_array: List[BarSourceDataAdvancedDegreeArrayInner] = Field(alias="advancedDegreeArray")
    bar_status_array: List[BarSourceDataBarStatusArrayInner] = Field(alias="barStatusArray")
    related_cases_array: List[BarSourceDataRelatedCasesArrayInner] = Field(alias="relatedCasesArray")
