...
class NormAttorneySearchResponse(BaseModel):
    ...
    norm_attorney_search_result_array: List[NormAttorneySearchResult] = Field(alias="normAttorneySearchResultArray")
    q: Annotated[str, Field(min_length=3, strict=True, max_length=2048)] = Field(description="Query been sent by client")
    norm_attorney_search_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(description="Query been sent by client", alias="normAttorneySearchId")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2120)]] = Field(description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2119)]] = Field(description="Link to previous page.", alias="previousPageAPI")
