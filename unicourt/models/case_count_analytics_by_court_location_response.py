...
class CaseCountAnalyticsByCourtLocationResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=41)]] = 'CaseCountAnalyticsByCourtLocationResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByCourtLocation]] = None
    ...
    total_court_location_count: Optional[StrictInt] = Field(default=None, description="Total no. of Court Location for this criteria.", alias="totalCourtLocationCount")
