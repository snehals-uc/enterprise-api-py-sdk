...
class CauseOfActionResponse(BaseModel):
    ...
    cause_of_action_array: List[CauseOfAction] = Field(alias="causeOfActionArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2146)]] = Field(description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2145)]] = Field(description="Link to previous page.", alias="previousPageAPI")
