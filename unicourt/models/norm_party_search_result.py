...
class NormPartySearchResult(BaseModel):
    ...
    norm_party_id: Annotated[str, Field(min_length=17, strict=True, max_length=18)] = Field(alias="normPartyId")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    party_classification_type: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="partyClassificationType")
    first_fetch_date: datetime = Field(alias="firstFetchDate")
    last_fetch_date: datetime = Field(alias="lastFetchDate")
    norm_party_details_api: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="normPartyDetailsAPI")
    matched_object_array: List[MatchedObject] = Field(alias="matchedObjectArray")
