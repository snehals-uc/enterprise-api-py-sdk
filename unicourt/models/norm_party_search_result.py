...
class NormPartySearchResult(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=21, strict=True, max_length=21)]] = 'NormPartySearchResult'
    norm_party_id: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=18)]] = Field(default=None, alias="normPartyId")
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = None
    party_classification_type: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, alias="partyClassificationType")
    ...
    norm_party_details_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, alias="normPartyDetailsAPI")
    matched_object_array: Optional[List[MatchedObject]] = Field(default=None, alias="matchedObjectArray")
    __properties: ClassVar[List[str]] = ["object", "normPartyId", "name", "partyClassificationType", "firstFetchDate", "lastFetchDate", "normPartyDetailsAPI", "matchedObjectArray"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'NormPartySearchResult',
            ...
            "normPartyDetailsAPI": obj.get("normPartyDetailsAPI"),
