...
class CourtTypeResponse(BaseModel):
    ...
    CourtTypeResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=17)]] = 'CourtTypeResponse'
    court_type_array: Optional[List[CourtType]] = Field(default=None, alias="courtTypeArray")
