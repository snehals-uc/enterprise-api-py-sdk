...
class CaseCountAnalyticsByNormJudgeResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=37)]] = 'CaseCountAnalyticsByNormJudgeResponse'
    results: Optional[List[CaseCountAnalyticsByNormJudge]] = None
    ...
    total_norm_judge_count: Optional[StrictInt] = Field(default=None, description="Total no. of NormJudge for this criteria.", alias="totalNormJudgeCount")
