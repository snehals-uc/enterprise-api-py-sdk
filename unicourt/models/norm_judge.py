...
class NormJudge(BaseModel):
    ...
    Norm Judge
    """ # noqa: E501
    object: Annotated[str, Field(strict=True, max_length=9)]
    ...
    judicial_data_array: List[NormJudgePublicData] = Field(alias="judicialDataArray")
    judge_analytics_api: JudgeAnalyticsAPI = Field(alias="judgeAnalyticsAPI")
