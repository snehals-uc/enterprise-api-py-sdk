...
class ChargeGroupResponse(BaseModel):
    ...
    ChargeGroupResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=19, strict=True, max_length=19)]] = 'ChargeGroupResponse'
    charge_group_array: Optional[List[ChargeGroup]] = Field(default=None, alias="chargeGroupArray")
