...
class BarSourceDataFeesOptionsArrayInner(BaseModel):
    ...
    """ # noqa: E501
    contingency_fees: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="contingencyFees")
    flat_fees: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="flatFees")
    hourly_rate: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="hourlyRate")
    payment_plans: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="paymentPlans")
    sliding_scale_fees: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="slidingScaleFees")
