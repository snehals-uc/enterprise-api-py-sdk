...
class NormParty(BaseModel):
    ...
    party_classification_type: Annotated[str, Field(strict=True, max_length=12)] = Field(alias="partyClassificationType")
    ...
    individual_data: Individual = Field(alias="individualData")
    norm_organization_data: NormOrganization = Field(alias="normOrganizationData")
    party_analytics_api: PartyAnalyticsAPI = Field(alias="partyAnalyticsAPI")
    related_norm_party_array: List[RelatedNormParty] = Field(alias="relatedNormPartyArray")
