...
class CaseCountAnalyticsByAreaOfLawResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=37)]] = 'CaseCountAnalyticsByAreaOfLawResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByAreaOfLaw]] = None
    ...
    total_area_of_law_count: Optional[StrictInt] = Field(default=None, description="Total no. of Area Of Law for this criteria.", alias="totalAreaOfLawCount")
