...
class CaseCountAnalyticsByNormLawFirmResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=39)]] = 'CaseCountAnalyticsByNormLawFirmResponse'
    results: Optional[List[CaseCountAnalyticsByNormLawFirm]] = None
    ...
    total_norm_law_firm_count: Optional[StrictInt] = Field(default=None, description="Total no. of NormLawFirm for this criteria.", alias="totalNormLawFirmCount")
