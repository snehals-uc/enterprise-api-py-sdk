...
class CaseClassResponse(BaseModel):
    ...
    CaseClassResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=17)]] = 'CaseClassResponse'
    case_class_array: Optional[List[CaseClass]] = Field(default=None, alias="caseClassArray")
    ...
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2140)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
