...
class JudgeTypeResponse(BaseModel):
    ...
    JudgeTypeResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=17)]] = 'JudgeTypeResponse'
    judge_type_array: Optional[List[JudgeType]] = Field(default=None, alias="judgeTypeArray")
