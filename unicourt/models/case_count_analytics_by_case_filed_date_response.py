...
class CaseCountAnalyticsByCaseFiledDateResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=41)]] = 'CaseCountAnalyticsByCaseFiledDateResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByCaseFiledDate]] = None
    ...
    total_case_filed_date_count: Optional[StrictInt] = Field(default=None, description="Total no. of Case File Date for this criteria.", alias="totalCaseFiledDateCount")
