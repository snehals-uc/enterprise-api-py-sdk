...
class NormOrganization(BaseModel):
    ...
    norm_organization_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="normOrganizationId")
    name: Annotated[str, Field(strict=True, max_length=500)]
    organization_type: Annotated[str, Field(strict=True, max_length=100)] = Field(alias="organizationType")
    lei: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    cik: Optional[Annotated[str, Field(strict=True, max_length=15)]]
    ticker_array: List[NormOrganizationTickerArrayInner] = Field(alias="tickerArray")
    naics: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    naics_description: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="naicsDescription")
    sic: Optional[Annotated[str, Field(strict=True, max_length=10)]]
    sic_description: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(alias="sicDescription")
    is_involved_in_litigation: StrictBool = Field(alias="isInvolvedInLitigation")
    norm_party_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="normPartyAPI")
    norm_corporate_group_array: List[NormCorporateGroup] = Field(alias="normCorporateGroupArray")
    sos_data_array: List[SOSData] = Field(alias="sosDataArray")
