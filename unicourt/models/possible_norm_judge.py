...
class PossibleNormJudge(BaseModel):
    ...
    PossibleNormJudge
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=17)]] = Field(default='PossibleNormJudge', description="Name of the object")
    norm_judge_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(default=None, alias="normJudgeId")
    norm_judge_name: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(default=None, alias="normJudgeName")
    ...
    score_constituents: Optional[PossibleNormJudgeScoreConstituents] = Field(default=None, alias="scoreConstituents")
    norm_judge_api: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Link to Details For the Judge.", alias="normJudgeAPI")
    ...
    case_count_analytics_by_norm_judge_api: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(default=None, alias="caseCountAnalyticsByNormJudgeAPI")
    __properties: ClassVar[List[str]] = ["object", "normJudgeId", "normJudgeName", "bestMatch", "confidenceScore", "scoreConstituents", "normJudgeAPI", "associatedNormAttorneysAPI", "associatedNormLawFirmsAPI", "associatedNormPartiesAPI", "caseCountAnalyticsByNormJudgeAPI"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'PossibleNormJudge',
            "normJudgeId": obj.get("normJudgeId"),
            "normJudgeName": obj.get("normJudgeName"),
            "bestMatch": obj.get("bestMatch") if obj.get("bestMatch") is not None else False,
            "confidenceScore": obj.get("confidenceScore"),
            "scoreConstituents": PossibleNormJudgeScoreConstituents.from_dict(obj["scoreConstituents"]) if obj.get("scoreConstituents") is not None else None,
            ...
            "caseCountAnalyticsByNormJudgeAPI": obj.get("caseCountAnalyticsByNormJudgeAPI")
        })
        return _obj
