...
class PossibleNormJudge(BaseModel):
    ...
    norm_judge_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="normJudgeId")
    norm_judge_name: Annotated[str, Field(strict=True, max_length=500)] = Field(alias="normJudgeName")
    best_match: StrictBool = Field(alias="bestMatch")
    confidence_score: Optional[Union[StrictFloat, StrictInt]] = Field(alias="confidenceScore")
    ...
    case_count_analytics_by_norm_judge_api: Annotated[str, Field(strict=True, max_length=250)] = Field(alias="caseCountAnalyticsByNormJudgeAPI")
