...
class AreaOfLawResponse(BaseModel):
    ...
    AreaOfLawResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=17)]] = 'AreaOfLawResponse'
    area_of_law_array: Optional[List[AreaOfLaw]] = Field(default=None, alias="areaOfLawArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2140)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2139)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
