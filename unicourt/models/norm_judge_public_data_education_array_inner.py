...
class NormJudgePublicDataEducationArrayInner(BaseModel):
    ...
    """ # noqa: E501
    degree: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(description="The Degree Awarded to the Judge")
    year: Optional[StrictInt] = Field(description="The year when the degree was awarded.")
    school: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(description="The University which awarded the degree to the Judge.")
