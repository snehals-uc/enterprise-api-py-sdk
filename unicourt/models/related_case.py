...
class RelatedCase(BaseModel):
    ...
    RelatedCase
    """ # noqa: E501
    object: Annotated[str, Field(min_length=11, strict=True, max_length=11)] = Field(description="Name of the object")
    case_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(description="Case ID of the related Case. This can be null if this case in not found in our database. However the meta information of the related case will be present.", alias="caseId")
    case_number: Annotated[str, Field(min_length=3, strict=True, max_length=50)] = Field(description="Case Number of the related Case.", alias="caseNumber")
    case_name: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(description="Case Name of the related Case.", alias="caseName")
    case_relationship_type: CaseRelationshipType = Field(alias="caseRelationshipType")
    source_case_relationship_type: Annotated[str, Field(min_length=3, strict=True, max_length=250)] = Field(description="Case Relationship Type provided by court.", alias="sourceCaseRelationshipType")
    is_visible: StrictBool = Field(description="This specifies if the related cases is still related to the parent case or not.", alias="isVisible")
    additional_source_data: SourceStructuredData = Field(alias="additionalSourceData")
    case_api: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="Link to the Case API of the current related case.", alias="caseAPI")
