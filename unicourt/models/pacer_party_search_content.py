...
class PACERPartySearchContent(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(min_length=23, strict=True, max_length=23)] = Field(description="Name of the object")
    ...
    pcl_last_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="This parameter represents the last name of the case when it is present", alias="pclLastName")
    pcl_first_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="This parameter represents the first name of the case when it is present", alias="pclFirstName")
    pcl_middle_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="This parameter represents the middle name of the case when it is present", alias="pclMiddleName")
    pcl_generation: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the generation of the case when it is present", alias="pclGeneration")
    pcl_party_role: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the party role of the case when it is present", alias="pclPartyRole")
    pcl_party_type: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the party type of the case when it is present", alias="pclPartyType")
