...
class NormAttorneySearchResult(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(min_length=24, strict=True, max_length=24)]
    norm_attorney_id: Annotated[str, Field(min_length=17, strict=True, max_length=18)] = Field(alias="normAttorneyId")
    ...
    norm_attorney_details_api: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="normAttorneyDetailsAPI")
