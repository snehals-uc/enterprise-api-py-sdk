...
class JurisdictionGeoResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=23, strict=True, max_length=23)]] = 'JurisdictionGeoResponse'
    jurisdiction_geo_array: Optional[List[JurisdictionGeo]] = Field(default=None, alias="jurisdictionGeoArray")
