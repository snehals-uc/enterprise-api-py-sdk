...
class CaseTrackPreview(BaseModel):
    ...
    CaseTrackPreview
    """ # noqa: E501
    object: Annotated[str, Field(min_length=16, strict=True, max_length=16)] = Field(description="Name of the object.")
    ...
    last_fetch_date_with_updates: Optional[datetime] = Field(description="The date and time when the case was last fetched from the Court where we found changes in the case information. This date and time is in UTC. Formatted as YYYY-MM-DDTHH:MM:SS+ZZ:zz,", alias="lastFetchDateWithUpdates")
    case_api: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="caseAPI")
    __properties: ClassVar[List[str]] = ["object", "caseId", "pacerOptions", "schedule", "lastTrackedDetails", "lastFetchDate", "lastFetchDateWithUpdates", "caseAPI"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'CaseTrackPreview',
