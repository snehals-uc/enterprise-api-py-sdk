...
class BarSourceDataBoardCertificationsArrayInner(BaseModel):
    """
    BarSourceDataBoardCertificationsArrayInner
    """ # noqa: E501
    area: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    year: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    __properties: ClassVar[List[str]] = ["area", "year"]
