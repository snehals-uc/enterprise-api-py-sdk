...
class ServiceHistory(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(strict=True, max_length=14)]
    appointed_by: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(description="The President-in-charge of the Judges appointment.", alias="appointedBy")
    reason_for_termination: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="The reason for the Judges termination for the current position.", alias="reasonForTermination")
    source_court: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(description="The court served by the Judge. The court is taken from source.", alias="sourceCourt")
    title: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="Title held by the Judge.")
    from_year: Optional[StrictInt] = Field(description="The year in which the Judge began practicing in his current service.", alias="fromYear")
    to_year: Optional[StrictInt] = Field(description="The year in which the Judge stoped practicing in his current service.", alias="toYear")
    from_date: Optional[datetime] = Field(description="The year in which the Judge began practicing in his current service.", alias="fromDate")
    to_date: Optional[datetime] = Field(description="The year in which the Judge stoped practicing in his current service.", alias="toDate")
    is_visible: StrictBool = Field(description="Boolean indicating if the service history  is visible or not.", alias="isVisible")
