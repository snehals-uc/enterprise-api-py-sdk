...
class RawOrderedDataChild(BaseModel):
    ...
    RawOrderedDataChild
    """ # noqa: E501
    child_array: List[RawOrderedDataChildChildArrayInner] = Field(description="Any docket text that belongs to the main docket text is added in the child.", alias="childArray")
    lbl: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="Label of the docket from the source.")
    ord: StrictInt = Field(description="Structure order.")
    val: Optional[Annotated[str, Field(strict=True, max_length=100000)]] = Field(description="List of available addresses.")
