...
from unicourt.models.callback_list_response_case_export_callbacks import CallbackListResponseCaseExportCallbacks
...
class CallbackListResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=20, strict=True, max_length=20)]] = Field(default='CallbackListResponse', description="Name of the object.")
    case_document_order_callbacks: Optional[CallbackListResponseCaseDocumentOrderCallbacks] = Field(default=None, alias="caseDocumentOrderCallbacks")
    case_export_callbacks: Optional[CallbackListResponseCaseExportCallbacks] = Field(default=None, alias="caseExportCallbacks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "caseExportCallbacks": CallbackListResponseCaseExportCallbacks.from_dict(obj["caseExportCallbacks"]) if obj.get("caseExportCallbacks") is not None else None
        })
        return _obj
