...
class PossibleNormAttorney(BaseModel):
    ...
    norm_attorney_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="normAttorneyAPI")
    ...
    case_count_analytics_by_norm_attorney_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="caseCountAnalyticsByNormAttorneyAPI")
