...
class PossibleNormLawFirm(BaseModel):
    ...
    norm_law_firm_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="normLawFirmId")
    norm_law_firm_name: Annotated[str, Field(strict=True, max_length=500)] = Field(alias="normLawFirmName")
    ...
    norm_law_firm_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="normLawFirmAPI")
    associated_norm_attorney_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="associatedNormAttorneyAPI")
    associated_norm_judge_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="associatedNormJudgeAPI")
    associated_norm_parties_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="associatedNormPartiesAPI")
    case_count_analytics_by_norm_law_firm_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="caseCountAnalyticsByNormLawFirmAPI")
    case_count_analytics_by_opposing_norm_law_firm_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="caseCountAnalyticsByOpposingNormLawFirmAPI")
