...
class CaseCountAnalyticsByCaseFiledDate(BaseModel):
    ...
    grouped_by: Annotated[str, Field(strict=True, max_length=9)] = Field(alias="groupedBy")
    year: StrictInt
    quarter: Optional[Annotated[str, Field(strict=True, max_length=4)]]
    month_string: Optional[Annotated[str, Field(strict=True, max_length=9)]] = Field(alias="monthString")
    month_int: Optional[StrictInt] = Field(alias="monthInt")
    week_of_year: Optional[StrictInt] = Field(alias="weekOfYear")
    week_of_month: Optional[StrictInt] = Field(alias="weekOfMonth")
