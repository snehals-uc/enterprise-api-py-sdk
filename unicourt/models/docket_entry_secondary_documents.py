...
class DocketEntrySecondaryDocuments(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(min_length=29, strict=True, max_length=29)] = Field(description="Name of the object")
    page_number: StrictInt = Field(description="Page number for which results where obtained.", alias="pageNumber")
    case_document_array: Annotated[List[CaseDocument], Field(max_length=100)] = Field(alias="caseDocumentArray")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'DocketEntrySecondaryDocuments',
