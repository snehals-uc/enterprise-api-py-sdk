...
class DocketEntrySecondaryDocuments(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=29, strict=True, max_length=29)]] = Field(default='DocketEntrySecondaryDocuments', description="Name of the object")
