...
class CaseCountAnalyticsByNormPartyResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=37)]] = 'CaseCountAnalyticsByNormPartyResponse'
    results: Optional[List[CaseCountAnalyticsByNormParty]] = None
    ...
    total_norm_party_count: Optional[StrictInt] = Field(default=None, description="Total no. of NormParty for this criteria.", alias="totalNormPartyCount")
