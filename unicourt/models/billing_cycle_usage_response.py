...
class BillingCycleUsageResponse(BaseModel):
    ...
    api_usage: Dict[str, Any] = Field(description="Billing cycle apiUsage.", alias="apiUsage")
    ...
    total_cases_tracked: StrictInt = Field(description="Total number of successful case tracks.", alias="totalCasesTracked")
