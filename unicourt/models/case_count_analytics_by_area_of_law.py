...
class CaseCountAnalyticsByAreaOfLaw(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=29)]] = 'CaseCountAnalyticsByAreaOfLaw'
    ...
    area_of_law: Optional[AreaOfLaw] = Field(default=None, alias="areaOfLaw")
