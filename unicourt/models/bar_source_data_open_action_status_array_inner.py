...
class BarSourceDataOpenActionStatusArrayInner(BaseModel):
    """
    BarSourceDataOpenActionStatusArrayInner
    """ # noqa: E501
    var_date: Optional[datetime] = Field(default=None, alias="date")
    reason: Optional[Annotated[str, Field(strict=True, max_length=250)]] = None
    __properties: ClassVar[List[str]] = ["date", "reason"]
