...
class CaseCountAnalyticsByPartyRoleGroupResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=42)]] = 'CaseCountAnalyticsByPartyRoleGroupResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByPartyRoleGroup]] = None
    ...
    total_party_role_group_count: Optional[StrictInt] = Field(default=None, description="Total no. of Party Role Group for this criteria.", alias="totalPartyRoleGroupCount")
