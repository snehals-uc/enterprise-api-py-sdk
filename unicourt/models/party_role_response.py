...
class PartyRoleResponse(BaseModel):
    ...
    PartyRoleResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=17)]] = 'PartyRoleResponse'
    party_role_array: Optional[List[PartyRole]] = Field(default=None, alias="partyRoleArray")
