...
class ChargeResponse(BaseModel):
    ...
    ChargeResponse
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=14, strict=True, max_length=14)]] = 'ChargeResponse'
    charge_array: Optional[List[Charge]] = Field(default=None, alias="chargeArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2137)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2136)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
