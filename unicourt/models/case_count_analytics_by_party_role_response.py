...
class CaseCountAnalyticsByPartyRoleResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=37)]] = 'CaseCountAnalyticsByPartyRoleResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByPartyRole]] = None
    ...
    total_party_role_count: Optional[StrictInt] = Field(default=None, description="Total no. of Party Role for this criteria.", alias="totalPartyRoleCount")
