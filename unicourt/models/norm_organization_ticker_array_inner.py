...
class NormOrganizationTickerArrayInner(BaseModel):
    """
    NormOrganizationTickerArrayInner
    """ # noqa: E501
    exchange: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    symbols: List[Annotated[str, Field(strict=True, max_length=250)]]
    __properties: ClassVar[List[str]] = ["exchange", "symbols"]
