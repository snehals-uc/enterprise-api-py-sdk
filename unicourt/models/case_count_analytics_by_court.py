...
class CaseCountAnalyticsByCourt(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(strict=True, max_length=25)]
    ...
    __properties: ClassVar[List[str]] = ["object", "caseCount", "caseSearchAPI", "court", "Geo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'CaseCountAnalyticsByCourt',
