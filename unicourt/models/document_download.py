...
class DocumentDownload(BaseModel):
    ...
    case_document_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(description="Requested Document ID.", alias="caseDocumentId")
    expiry_date: Optional[Annotated[str, Field(min_length=25, strict=True, max_length=25)]] = Field(description="Expiry date-time for the fileUrl provided in this object.", alias="expiryDate")
    file_url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(description="Link to download the file.", alias="fileUrl")
    case_document_download_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(description="API call to download the document again if the above fileUrl is expired.", alias="caseDocumentDownloadAPI")
    exception: Exception
