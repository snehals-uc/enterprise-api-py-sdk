...
class AttorneyTypeResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=20, strict=True, max_length=20)]] = 'AttorneyTypeResponse'
    attorney_type_array: Optional[List[AttorneyType]] = Field(default=None, alias="attorneyTypeArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2145)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2144)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
