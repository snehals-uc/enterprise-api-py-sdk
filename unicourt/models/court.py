...
class Court(BaseModel):
    ...
    Court
    """ # noqa: E501
    object: Annotated[str, Field(min_length=5, strict=True, max_length=5)]
    court_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="courtId")
    court_type_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="courtTypeId")
    court_system_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="courtSystemId")
    type: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    system: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    name_aka: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="nameAka")
    additional_levels: AdditionalLevels = Field(alias="additionalLevels")
    container_type: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(alias="containerType")
    container: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]]
    created_date: datetime = Field(description="The date and time when the Court was first created. This date and time is in UTC. Formatted as YYYY-MM-DD HH:MM:SS.", alias="createdDate")
    jurisdiction_geo_for_court_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(alias="jurisdictionGeoForCourtAPI")
    court_locations_for_court_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(alias="courtLocationsForCourtAPI")
    appeal_courts_for_court_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(alias="appealCourtsForCourtAPI")
    court_service_status_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]] = Field(alias="courtServiceStatusAPI")
