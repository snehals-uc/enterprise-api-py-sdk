...
class PossibleNormParty(BaseModel):
    ...
    norm_party_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="normPartyId")
    norm_party_name: Annotated[str, Field(strict=True, max_length=500)] = Field(alias="normPartyName")
    ...
    case_count_analytics_by_norm_party_api: Annotated[str, Field(strict=True, max_length=255)] = Field(alias="caseCountAnalyticsByNormPartyAPI")
