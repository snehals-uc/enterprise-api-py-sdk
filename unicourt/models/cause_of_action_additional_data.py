...
class CauseOfActionAdditionalData(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(min_length=27, strict=True, max_length=27)]
    cause_of_action_additional_data_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="causeOfActionAdditionalDataId")
