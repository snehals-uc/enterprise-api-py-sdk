...
class AssociatedNormLawFirm(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=21)]] = 'AssociatedNormLawFirm'
    ...
    norm_law_firm_api: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Link to Details for this Law Firm.", alias="normLawFirmAPI")
