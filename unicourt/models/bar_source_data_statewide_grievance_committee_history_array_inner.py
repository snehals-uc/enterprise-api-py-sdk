...
class BarSourceDataStatewideGrievanceCommitteeHistoryArrayInner(BaseModel):
    ...
    """ # noqa: E501
    final_decision: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="finalDecision")
    final_decision_date: Optional[datetime] = Field(alias="finalDecisionDate")
    grievance_complaint_number: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="grievanceComplaintNumber")
    public_comments: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(alias="publicComments")
