...
class Attorneys(BaseModel):
    ...
    Attorneys
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=9, strict=True, max_length=9)]] = Field(default='Attorneys', description="Name of the object")
    ...
    attorney_array: Optional[Annotated[List[Attorney], Field(max_length=25)]] = Field(default=None, alias="attorneyArray")
