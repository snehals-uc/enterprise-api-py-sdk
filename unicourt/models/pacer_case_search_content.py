...
class PACERCaseSearchContent(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(min_length=22, strict=True, max_length=22)] = Field(description="Name of the object")
    pcl_case_link: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="Link to case in the case management/electronic case files (CM/ECF) system at the court.", alias="pclCaseLink")
    pcl_jurisdiction_type: Optional[StrictStr] = Field(description="Link to case in the case management/electronic case files (CM/ECF) system at the court.", alias="pclJurisdictionType")
    pcl_case_id: StrictInt = Field(description="Sequentially generated number that identifies the case.", alias="pclCaseId")
    pcl_case_number_full: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="Case Number.", alias="pclCaseNumberFull")
    pcl_case_title: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="Title of the case.", alias="pclCaseTitle")
    pcl_case_office: Optional[Annotated[str, Field(strict=True, max_length=2)]] = Field(description="The divisional office in which the case was filed.", alias="pclCaseOffice")
    pcl_case_number: StrictInt = Field(description="The sequence number of the case.", alias="pclCaseNumber")
    pcl_case_type: Optional[Annotated[str, Field(strict=True, max_length=6)]] = Field(description="Code that identifies the type of case.", alias="pclCaseType")
    pcl_case_year: StrictInt = Field(description="The year in which the case falls. Could be two or four digit.", alias="pclCaseYear")
    pcl_court_id: Optional[Annotated[str, Field(strict=True, max_length=6)]] = Field(description="The general geographical region or specific court district. The court ID is the abbreviation of the court location combined with the court type (dc or bk). Please refer the Appendix B", alias="pclCourtId")
    pcl_date_filed: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="Filing date of the case.", alias="pclDateFiled")
    pcl_jpml_number: Optional[StrictInt] = Field(description="JPML Case Seed number.", alias="pclJpmlNumber")
    pcl_mdl_court_id: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="Which court does this mdl belongs too.", alias="pclMdlCourtId")
    pcl_mdl_date_ordered: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the mdl date ordered of the case when it is present", alias="pclMdlDateOrdered")
    pcl_mdl_date_received: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the mdl date received of the case when it is present", alias="pclMdlDateReceived")
    pcl_mdl_extension: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the mdl extension of the case when it is present", alias="pclMdlExtension")
    pcl_mdl_judge_last_name: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the mdl judge lastname of the case when it is present", alias="pclMdlJudgeLastName")
    pcl_mdl_littype: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the mdl lit type of the case when it is present", alias="pclMdlLittype")
    pcl_mdl_status: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the mdl status of the case when it is present", alias="pclMdlStatus")
    pcl_mdl_transferee: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the mdl transferee of the case when it is present", alias="pclMdlTransferee")
    pcl_mdl_transferee_district: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the mdl transferee district of the case when it is present", alias="pclMdlTransfereeDistrict")
    pcl_civil_cto_number: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the civil cto number of the case when it is present", alias="pclCivilCtoNumber")
    pcl_civil_date_disposition: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the civil disposition date of the case when it is present", alias="pclCivilDateDisposition")
    pcl_civil_date_initiated: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the civil initiated date of the case when it is present", alias="pclCivilDateInitiated")
    pcl_civil_date_terminated: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the civil terminated date of the case when it is present", alias="pclCivilDateTerminated")
    pcl_civil_stat_disposition: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the civil stat disposition of the case when it is present", alias="pclCivilStatDisposition")
    pcl_civil_stat_initiated: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the civil stat initiated of the case when it is present", alias="pclCivilStatInitiated")
    pcl_civil_stat_terminated: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the civil stat terminated of the case when it is present", alias="pclCivilStatTerminated")
    pcl_civil_transferee: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the civil transferee of the case when it is present", alias="pclCivilTransferee")
    pcl_bankruptcy_chapter: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the bankruptcy chapter of the case when it is present", alias="pclBankruptcyChapter")
    pcl_date_discharged: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the date discharged of the case when it is present", alias="pclDateDischarged")
    pcl_date_dismissed: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the date dismissed of the case when it is present", alias="pclDateDismissed")
    pcl_date_reopened: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the date reopened of the case when it is present", alias="pclDateReopened")
    pcl_date_termed: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the date termed of the case when it is present", alias="pclDateTermed")
    pcl_disposition: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(description="This parameter represents the disposition of the case when it is present", alias="pclDisposition")
    pcl_disposition_method: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(description="This parameter represents the disposition method of the case when it is present", alias="pclDispositionMethod")
    pcl_joint_bankruptcy_flag: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the joint bankruptcy flag of the case when it is present", alias="pclJointBankruptcyFlag")
    pcl_joint_discharged_date: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the joint discharged date of the case when it is present", alias="pclJointDischargedDate")
    pcl_joint_dismissed_date: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(description="This parameter represents the joint dismissed date of the case when it is present", alias="pclJointDismissedDate")
    pcl_joint_disposition_method: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(description="This parameter represents the joint disposition method of the case when it is present", alias="pclJointDispositionMethod")
    pcl_nature_of_suit: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="This parameter represents the nature of suit of the case when it is present", alias="pclNatureOfSuit")
