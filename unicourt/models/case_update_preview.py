...
class CaseUpdatePreview(BaseModel):
    ...
    requested_date: datetime = Field(description="The date and time when the case was last requested for update ", alias="requestedDate")
    ...
    exception: Exception
    __properties: ClassVar[List[str]] = ["object", "caseId", "status", "requestedDate", "caseAPI", "pacerOptions", "exception"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'CaseUpdatePreview',
