...
class Contact(BaseModel):
    ...
    address_array: List[Address] = Field(description="List of available addresses.", alias="addressArray")
    phone_number_array: List[Phone] = Field(description="List of available phone numbers.", alias="phoneNumberArray")
    email_array: List[Email] = Field(description="List of available emails.", alias="emailArray")
