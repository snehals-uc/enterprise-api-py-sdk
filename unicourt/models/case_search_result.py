...
class CaseSearchResult(BaseModel):
    ...
    case_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="caseId")
    case_name: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="caseName")
    case_number: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="caseNumber")
    ...
    participants_last_fetch_date: Optional[datetime] = Field(alias="participantsLastFetchDate")
