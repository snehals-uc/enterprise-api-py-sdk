...
class CaseCountAnalyticsByNormAttorneyResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=40)]] = 'CaseCountAnalyticsByNormAttorneyResponse'
    results: Optional[List[CaseCountAnalyticsByNormAttorney]] = None
    ...
    total_norm_attorney_count: Optional[StrictInt] = Field(default=None, description="Total no. of NormAttorney for this criteria.", alias="totalNormAttorneyCount")
