...
class CaseCountAnalyticsByCourtResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=33)]] = 'CaseCountAnalyticsByCourtResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByCourt]] = None
    ...
    total_court_count: Optional[StrictInt] = Field(default=None, description="Total no. of Court for this criteria.", alias="totalCourtCount")
