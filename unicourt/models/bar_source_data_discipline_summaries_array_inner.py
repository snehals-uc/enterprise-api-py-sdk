...
class BarSourceDataDisciplineSummariesArrayInner(BaseModel):
    """
    ...
    title: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    __properties: ClassVar[List[str]] = ["date", "link", "title"]
