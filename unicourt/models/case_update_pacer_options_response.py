...
class CaseUpdatePacerOptionsResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=30, strict=True, max_length=30)]] = Field(default='CaseUpdatePacerOptionsResponse', description="Name of the object.")
