...
class DailyUsageResponse(BaseModel):
    ...
    usage_start_time: datetime = Field(description="Start time of the usage.", alias="usageStartTime")
    usage_end_time: datetime = Field(description="End time of the usage.", alias="usageEndTime")
    api_usage: Dict[str, Any] = Field(description="Api Usage made in real time.", alias="apiUsage")
