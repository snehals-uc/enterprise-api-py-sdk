...
class BarSourceDataDisciplinaryHistoryArrayInner(BaseModel):
    ...
    """ # noqa: E501
    action: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    case_number: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="caseNumber")
    complaint: Optional[Annotated[str, Field(strict=True, max_length=1000)]]
    contact_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=250)]] = Field(alias="contactId")
    date_of_action: Optional[datetime] = Field(alias="dateOfAction")
    definition: Optional[Annotated[str, Field(strict=True, max_length=1000)]]
    disciplinary_decision: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="disciplinaryDecision")
    entry_date: Optional[datetime] = Field(alias="entryDate")
    information: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    link: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    note: Optional[Annotated[str, Field(strict=True, max_length=1000)]]
    probation_date: Optional[datetime] = Field(alias="probationDate")
    reinstated_date: Optional[datetime] = Field(alias="reinstatedDate")
    rule: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    rule_number: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="ruleNumber")
    section_date: Optional[datetime] = Field(alias="sectionDate")
    status: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    stay_date: Optional[datetime] = Field(alias="stayDate")
    supreme_court: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="supremeCourt")
    term: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    type_of_action: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(alias="typeOfAction")
