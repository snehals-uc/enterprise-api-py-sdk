...
class PartyRoleGroupResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=22, strict=True, max_length=22)]] = 'PartyRoleGroupResponse'
    party_role_group_array: Optional[List[PartyRoleGroup]] = Field(default=None, alias="partyRoleGroupArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2147)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2146)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
