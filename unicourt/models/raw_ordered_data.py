...
class RawOrderedData(BaseModel):
    ...
    RawOrderedData
    """ # noqa: E501
    child_array: Optional[List[RawOrderedDataChild]] = Field(default=None, description="Any docket text that belongs to the main docket text is added in the child.", alias="childArray")
    lbl: Optional[Annotated[str, Field(strict=True, max_length=100000)]] = Field(default=None, description="Label of the docket from the source.")
    ord: Optional[StrictInt] = Field(default=None, description="Structure order")
    val: Optional[Annotated[str, Field(strict=True, max_length=1000000)]] = Field(default=None, description="List of available addresses.")
