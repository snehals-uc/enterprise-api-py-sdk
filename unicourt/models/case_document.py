...
class CaseDocument(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=100000)]] = Field(default=None, description="Description of the document.")
    ...
    def source_data_status_validate_enum(cls, value):
        ...
        if value not in set(['NO_LONGER_AVAILABLE_IN_COURT', 'SOURCE_DEPRECATED', 'SEALED', 'null']):
            raise ValueError("must be one of enum values ('NO_LONGER_AVAILABLE_IN_COURT', 'SOURCE_DEPRECATED', 'SEALED', 'null')")
        return value
