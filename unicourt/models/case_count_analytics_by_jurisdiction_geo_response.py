...
class CaseCountAnalyticsByJurisdictionGeoResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=43)]] = 'CaseCountAnalyticsByJurisdictionGeoResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByJurisdictionGeo]] = None
    ...
    total_jurisdiction_geo_count: Optional[StrictInt] = Field(default=None, description="Total no. of Jurisdiction for this criteria.", alias="totalJurisdictionGeoCount")
