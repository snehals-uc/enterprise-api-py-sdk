...
class Judges(BaseModel):
    ...
    Judges
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=6, strict=True, max_length=6)]] = Field(default='Judges', description="Name of the object")
    ...
    judge_array: Optional[Annotated[List[Judge], Field(max_length=25)]] = Field(default=None, alias="judgeArray")
