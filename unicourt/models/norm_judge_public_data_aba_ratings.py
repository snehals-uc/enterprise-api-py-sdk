...
class NormJudgePublicDataAbaRatings(BaseModel):
    ...
    """ # noqa: E501
    rating: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="rating")
    year: Optional[StrictInt] = Field(description="Year when Rating was recieved.")
    __properties: ClassVar[List[str]] = ["rating", "year"]
