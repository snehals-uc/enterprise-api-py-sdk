...
class NormLawFirmSearchResult(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=23, strict=True, max_length=23)]] = 'NormLawFirmSearchResult'
    norm_law_firm_id: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=18)]] = Field(default=None, alias="normLawFirmId")
    ...
    norm_law_firm_details_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, alias="normLawFirmDetailsAPI")
    matched_object_array: Optional[List[MatchedObject]] = Field(default=None, alias="matchedObjectArray")
    __properties: ClassVar[List[str]] = ["object", "normLawFirmId", "name", "firstFetchDate", "lastFetchDate", "normLawFirmDetailsAPI", "matchedObjectArray"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'NormLawFirmSearchResult',
            "normLawFirmId": obj.get("normLawFirmId"),
            "name": obj.get("name"),
            "firstFetchDate": obj.get("firstFetchDate"),
            "lastFetchDate": obj.get("lastFetchDate"),
            "normLawFirmDetailsAPI": obj.get("normLawFirmDetailsAPI"),
