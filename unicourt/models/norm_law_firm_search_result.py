...
class NormLawFirmSearchResult(BaseModel):
    ...
    norm_law_firm_id: Annotated[str, Field(min_length=17, strict=True, max_length=18)] = Field(alias="normLawFirmId")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    first_fetch_date: datetime = Field(alias="firstFetchDate")
    last_fetch_date: datetime = Field(alias="lastFetchDate")
    norm_law_firm_details_api: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="normLawFirmDetailsAPI")
