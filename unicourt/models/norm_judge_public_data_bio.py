...
class NormJudgePublicDataBio(BaseModel):
    ...
    """ # noqa: E501
    ethnicity: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="Ethnic Group of the Judge.")
    birth_city: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="The Birth City of the Judge.", alias="birthCity")
    birth_date: Optional[datetime] = Field(description="The Date of Birth of the Judge.", alias="birthDate")
    birth_state: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="The Birth State of the Judge.", alias="birthState")
    death_city: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="The Death City of the Judge.", alias="deathCity")
    death_date: Optional[datetime] = Field(description="The Date of the Death of the Judge.", alias="deathDate")
    death_state: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="The Death State of the Judge.", alias="deathState")
    political_affiliation: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(description="The Political Affiliation of the Judge.", alias="politicalAffiliation")
