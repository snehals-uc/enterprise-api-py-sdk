...
class Hearings(BaseModel):
    ...
    Hearings
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=8, strict=True, max_length=8)]] = Field(default='Hearings', description="Name of the object")
    ...
    hearing_array: Optional[List[Hearing]] = Field(default=None, alias="hearingArray")
