...
class CaseTypeGroupResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=21, strict=True, max_length=21)]] = 'CaseTypeGroupResponse'
    case_type_group_array: Optional[List[CaseTypeGroup]] = Field(default=None, alias="caseTypeGroupArray")
