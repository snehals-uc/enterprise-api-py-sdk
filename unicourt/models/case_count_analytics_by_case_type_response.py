...
class CaseCountAnalyticsByCaseTypeResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=36)]] = 'CaseCountAnalyticsByCaseTypeResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByCaseType]] = None
    ...
    total_case_type_count: Optional[StrictInt] = Field(default=None, description="Total no. of CaseType for this criteria.", alias="totalCaseTypeCount")
