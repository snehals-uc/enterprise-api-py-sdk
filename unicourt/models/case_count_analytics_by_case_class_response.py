...
class CaseCountAnalyticsByCaseClassResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=37)]] = 'CaseCountAnalyticsByCaseClassResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByCaseClass]] = None
    ...
    total_case_class_count: Optional[StrictInt] = Field(default=None, description="Total no. of Case Class for this criteria.", alias="totalCaseClassCount")
