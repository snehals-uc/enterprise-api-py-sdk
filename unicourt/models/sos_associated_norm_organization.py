...
class SOSAssociatedNormOrganization(BaseModel):
    ...
    norm_organization_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(alias="normOrganizationId")
    norm_organization_api: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(alias="normOrganizationAPI")
    relationship_type: Annotated[str, Field(strict=True, max_length=6)] = Field(alias="relationshipType")
