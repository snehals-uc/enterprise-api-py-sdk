...
class PACERPartySearchResults(BaseModel):
    ...
    has_only_meta_info: StrictBool = Field(description="This field determines if the UniCourt Content has only meta information. If the value is true and you require to get the latest updates of the case you will need to make a request to the updateCase API.", alias="hasOnlyMetaInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'PACERPartySearchResults',
            "pacerContent": PACERPartySearchContent.from_dict(obj["pacerContent"]) if obj.get("pacerContent") is not None else None,
