...
class PACERPartySearchResults(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=23, strict=True, max_length=23)]] = Field(default='PACERPartySearchResults', description="Name of the object")
    pacer_content: Optional[PACERPartySearchContent] = Field(default=None, alias="pacerContent")
