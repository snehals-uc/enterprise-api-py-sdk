...
class CaseCountAnalyticsByCourtTypeResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=37)]] = 'CaseCountAnalyticsByCourtTypeResponse'
    ...
    results: Optional[List[CaseCountAnalyticsByCourtType]] = None
    ...
    total_court_type_count: Optional[StrictInt] = Field(default=None, description="Total no. of Court Type for this criteria.", alias="totalCourtTypeCount")
