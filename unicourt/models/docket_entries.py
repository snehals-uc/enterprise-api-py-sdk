...
class DocketEntries(BaseModel):
    ...
    DocketEntries
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=13, strict=True, max_length=13)]] = Field(default='DocketEntries', description="Name of the object")
    ...
    docket_entry_array: Optional[Annotated[List[DocketEntry], Field(max_length=100)]] = Field(default=None, alias="docketEntryArray")
