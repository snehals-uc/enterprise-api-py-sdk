...
class RelatedCases(BaseModel):
    ...
    RelatedCases
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=12, strict=True, max_length=12)]] = Field(default='RelatedCases', description="Name of the object")
    ...
    related_case_array: Optional[Annotated[List[RelatedCase], Field(max_length=100)]] = Field(default=None, alias="relatedCaseArray")
