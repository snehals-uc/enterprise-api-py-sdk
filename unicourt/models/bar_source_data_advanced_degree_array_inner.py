...
class BarSourceDataAdvancedDegreeArrayInner(BaseModel):
    """
    BarSourceDataAdvancedDegreeArrayInner
    """ # noqa: E501
    area: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    degree: Optional[Annotated[str, Field(strict=True, max_length=250)]]
    __properties: ClassVar[List[str]] = ["area", "degree"]
