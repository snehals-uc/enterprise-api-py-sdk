...
class SourceCaseData(BaseModel):
    ...
    """ # noqa: E501
    object: Annotated[str, Field(min_length=14, strict=True, max_length=14)] = Field(description="Name of the object")
    source_court: Annotated[str, Field(strict=True, max_length=250)] = Field(description="Courtrhouse as provided by Court.", alias="sourceCourt")
    source_case_type: Annotated[str, Field(strict=True, max_length=250)] = Field(description="Case Type for a case which is provided by the Court.", alias="sourceCaseType")
    source_charge_array: List[SourceCharge] = Field(description="Array of Charges for a case which is provided by the Court.", alias="sourceChargeArray")
    nature_of_suit_array: List[NatureOfSuit] = Field(description="Array of Charges for a case which is provided by the Court.", alias="natureOfSuitArray")
    source_cause_of_action_array: List[SourceCauseOfAction] = Field(description="Array of Cause Of Action for a case which is provided by the Court.", alias="sourceCauseOfActionArray")
    source_case_status: Annotated[str, Field(strict=True, max_length=250)] = Field(description="Case Status as provided by Court.", alias="sourceCaseStatus")
    source_page_data: List[SourcePageData] = Field(alias="sourcePageData")
