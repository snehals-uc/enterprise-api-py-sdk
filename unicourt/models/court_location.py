...
class CourtLocation(BaseModel):
    ...
    court_location_id: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(alias="courtLocationId")
    ...
    street_address2: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(description="2nd part of the street address.", alias="streetAddress2")
    city: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(description="City")
    state_name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="State Name if present else default value.", alias="stateName")
    ...
    courts_for_court_location_api: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="courtsForCourtLocationAPI")
