...
class CourtLocationResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=21, strict=True, max_length=21)]] = 'CourtLocationResponse'
    court_location_array: Optional[List[CourtLocation]] = Field(default=None, alias="courtLocationArray")
    next_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2144)]] = Field(default=None, description="Link to next page.", alias="nextPageAPI")
    previous_page_api: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2143)]] = Field(default=None, description="Link to previous page.", alias="previousPageAPI")
