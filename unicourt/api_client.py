...
from unicourt.api_response import ApiResponse, T as ApiResponseT
import unicourt.models
    ...
    def response_deserialize(
        ...
        try:
            ...
            if not 200 <= response_data.status <= 299:
                raise SdkException.from_response(
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(unicourt.models, klass)
