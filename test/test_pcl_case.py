...
class TestPCLCase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PCLCase:
        """Test PCLCase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PCLCase`
        """
        model = PCLCase()
        if include_optional:
            return PCLCase(
                ...
                pacer_search_results_array = [
                    unicourt.models.pacer_case_search_results.PACERCaseSearchResults(
