...
class TestCaseSearchResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CaseSearchResponse:
        """Test CaseSearchResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaseSearchResponse`
        """
        model = CaseSearchResponse()
        if include_optional:
            return CaseSearchResponse(
                object = 'CaseSearchResponse',
                case_search_result_array = [
                    unicourt.models.case_search_result.CaseSearchResult(
                ...
                q = '012',
                case_search_id = '01234567891011121314151617',
                next_page_api = '0',
                previous_page_api = '0',
                page_number = 1,
                total_pages = 1,
