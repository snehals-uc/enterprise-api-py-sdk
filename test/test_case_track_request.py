...
class TestCaseTrackRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CaseTrackRequest:
        """Test CaseTrackRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaseTrackRequest`
        """
        model = CaseTrackRequest()
        if include_optional:
            return CaseTrackRequest(
                case_track_params = unicourt.models.case_update_request.CaseUpdateRequest(
