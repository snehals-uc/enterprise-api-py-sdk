...
class TestPACERImportCase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PACERImportCase:
        """Test PACERImportCase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PACERImportCase`
        """
        model = PACERImportCase()
        if include_optional:
            return PACERImportCase(
                object = 'PACERImportCase',
                court_fee = 1.337,
                pacer_import_case_results_array = [
                    unicourt.models.pacer_import_case_results.PACERImportCaseResults(
