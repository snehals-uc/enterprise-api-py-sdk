...
class TestPACERCaseSearchContent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PACERCaseSearchContent:
        """Test PACERCaseSearchContent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PACERCaseSearchContent`
        """
        model = PACERCaseSearchContent()
        if include_optional:
