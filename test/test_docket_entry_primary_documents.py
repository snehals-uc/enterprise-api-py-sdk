...
class TestDocketEntryPrimaryDocuments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocketEntryPrimaryDocuments:
        """Test DocketEntryPrimaryDocuments
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocketEntryPrimaryDocuments`
        """
        model = DocketEntryPrimaryDocuments()
        if include_optional:
