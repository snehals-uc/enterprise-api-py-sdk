...
class TestCaseCountAnalyticsByCaseTypeGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CaseCountAnalyticsByCaseTypeGroup:
        """Test CaseCountAnalyticsByCaseTypeGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaseCountAnalyticsByCaseTypeGroup`
        """
        model = CaseCountAnalyticsByCaseTypeGroup()
        if include_optional:
