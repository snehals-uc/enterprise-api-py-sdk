...
class TestCaseUpdatePacerOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CaseUpdatePacerOptions:
        """Test CaseUpdatePacerOptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaseUpdatePacerOptions`
        """
        model = CaseUpdatePacerOptions()
        if include_optional:
