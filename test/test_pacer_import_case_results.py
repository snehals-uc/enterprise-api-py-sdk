...
class TestPACERImportCaseResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PACERImportCaseResults:
        """Test PACERImportCaseResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PACERImportCaseResults`
        """
        model = PACERImportCaseResults()
        if include_optional:
