...
class TestNormJudge(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NormJudge:
        """Test NormJudge
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NormJudge`
        """
        model = NormJudge()
        if include_optional:
            return NormJudge(
                ...
                judicial_data_array = [
                    unicourt.models.norm_judge_public_data.NormJudgePublicData(
                ...
                judge_analytics_api = unicourt.models.judge_analytics_api.JudgeAnalyticsAPI(
