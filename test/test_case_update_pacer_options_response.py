...
class TestCaseUpdatePacerOptionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CaseUpdatePacerOptionsResponse:
        """Test CaseUpdatePacerOptionsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaseUpdatePacerOptionsResponse`
        """
        model = CaseUpdatePacerOptionsResponse()
        if include_optional:
