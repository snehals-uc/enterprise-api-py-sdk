...
class TestCaseDocumentOrderCallback(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CaseDocumentOrderCallback:
        """Test CaseDocumentOrderCallback
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaseDocumentOrderCallback`
        """
        model = CaseDocumentOrderCallback()
        if include_optional:
