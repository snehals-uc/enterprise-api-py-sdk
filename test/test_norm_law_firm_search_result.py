...
class TestNormLawFirmSearchResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NormLawFirmSearchResult:
        """Test NormLawFirmSearchResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NormLawFirmSearchResult`
        """
        model = NormLawFirmSearchResult()
        if include_optional:
