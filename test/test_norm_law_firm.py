...
class TestNormLawFirm(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NormLawFirm:
        """Test NormLawFirm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NormLawFirm`
        """
        model = NormLawFirm()
        if include_optional:
            return NormLawFirm(
                ...
                law_firm_analytics_api = unicourt.models.law_firm_analytics_api.LawFirmAnalyticsAPI(
