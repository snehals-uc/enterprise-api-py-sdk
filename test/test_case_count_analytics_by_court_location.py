...
class TestCaseCountAnalyticsByCourtLocation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CaseCountAnalyticsByCourtLocation:
        """Test CaseCountAnalyticsByCourtLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaseCountAnalyticsByCourtLocation`
        """
        model = CaseCountAnalyticsByCourtLocation()
        if include_optional:
