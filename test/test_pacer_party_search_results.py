...
class TestPACERPartySearchResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PACERPartySearchResults:
        """Test PACERPartySearchResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PACERPartySearchResults`
        """
        model = PACERPartySearchResults()
        if include_optional:
